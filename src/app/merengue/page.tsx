...
export default function Page() {
    ...
    <main className="text-center px-5">
      <CourseBanner imageSrc="/salsabanner.jpg" title="Merengue" />
      <div className="my-8">
        <h1 className="text-3xl font-bold mb-4">Merengue Dance Course</h1>
        <p className="text-lg text-gray-700 mb-8">Learn the art of Merengue dancing with our comprehensive courses designed for all skill levels.</p>
