...
export default function Deals({ onJoinClick }: { onJoinClick: (title: string, date: string) => void }) {
  return (
    <section className="w-full max-w-4xl mx-auto mb-12">
      ...
      <div className="flex items-center border-b border-gray-300 py-6">
        ...
        <div>
          ...
          <button 
            onClick={() => onJoinClick('Beginner Bachata', 'Oct 7, 2024 - Nov 25, 2024')}
      ...
      <div className="flex items-center py-6">
        ...
        <div>
          ...
          <p className="font-bold mb-4">$60</p>
          <button 
            onClick={() => onJoinClick('Beginner Salsa', 'Oct 10, 2024 - Nov 28, 2024')}
            className="bg-blue-500 text-white py-2 px-4 rounded-md"
          >
            Join
          </button>
